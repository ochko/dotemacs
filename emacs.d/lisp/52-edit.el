;;; General editing and authoring -*- lexical-binding: t -*-
...
(use-package jinx
  ...
  ;; Skip code, links, and tags in org-mode
  (add-to-list 'jinx-exclude-faces
               '(org-mode
                 org-block
...
;; Emacs 31 will have markdown-ts-mode, until then use this
